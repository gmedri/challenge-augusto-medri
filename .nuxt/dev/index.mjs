import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getRequestURL, isMethod, getResponseStatusText } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/h3/dist/index.mjs';
import { resolveHTTPResponse } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/@trpc/server/dist/http/index.mjs';
import { TRPCError, initTRPC } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/@trpc/server/dist/index.mjs';
import { getErrorShape } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/@trpc/server/dist/shared/index.mjs';
import { z } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/zod/lib/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/devalue/index.js';
import destr from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/unctx/dist/index.mjs';
import { isVNode, version, unref } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/augustomedri/Documents/GitHub/challenge-augusto-medri/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/augustomedri/Documents/GitHub/challenge-augusto-medri","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/augustomedri/Documents/GitHub/challenge-augusto-medri/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/augustomedri/Documents/GitHub/challenge-augusto-medri/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/augustomedri/Documents/GitHub/challenge-augusto-medri/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/augustomedri/Documents/GitHub/challenge-augusto-medri/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _w7CS2cURsQ = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/augustomedri/Documents/GitHub/challenge-augusto-medri";
...
const _lazy_niotNI = () => Promise.resolve().then(function () { return _trpc_$1; });
const _lazy_ePOw7J = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/trpc/:trpc', handler: _lazy_niotNI, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_ePOw7J, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ePOw7J, lazy: true, middleware: false, method: undefined }
];
...
const appRouter = router({
  ...
  addProduct: publicProcedure.input(
    ...
    return { id: Math.floor(Math.random() * 1e3), ...input };
  })
});
...
const getClientManifest = () => import('file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/augustomedri/Documents/GitHub/challenge-augusto-medri/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
